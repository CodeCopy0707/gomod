isspython code ko more advance bnao fast bnao and go lang me bnao full files codes isse and isme or bhi tools features add kro isme ye tools bhi add kro iske persent tools me isse more advance bnao more tools do isse like isme real sab lgao logics mock remove krke gemini ke mistral ke and deepseek ke ye apis MISTRAL_API_KEY='vlVy39wyXd1jkURNevvMkGuqKaPBj3Ek'
...
load_dotenv()
client = OpenAI(
    api_key='sk-149b6506d0fc498f98a4cde846a6b87f',
